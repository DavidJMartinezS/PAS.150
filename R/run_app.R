...
#' @importFrom leaflet addCircles addLayersControl addLegend addMeasure addMiniMap addPolygons addProviderTiles addScaleBar colorFactor highlightOptions layersControlOptions leaflet leafletOutput providers renderLeaflet scaleBarOptions 
...
#' @importFrom openxlsx2 fmt_txt int2col wb_add_border wb_add_cell_style wb_add_data wb_add_data_table wb_add_fill wb_add_font wb_add_formula wb_add_image wb_add_numfmt wb_add_pivot_table wb_add_worksheet wb_color wb_data wb_dims wb_merge_cells wb_page_setup wb_save wb_set_col_widths wb_workbook 
#' @importFrom plotly layout plot_ly plotlyOutput renderPlotly 
#' @importFrom plyr round_any 
#' @importFrom purrr compact map map_dbl map_lgl map2_dbl pmap_chr pmap_dbl pwalk 
...
#' @importFrom stringr str_c str_detect str_replace_all str_to_upper 
