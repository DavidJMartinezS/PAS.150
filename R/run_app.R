...
#' @importFrom purrr compact every map map_dbl map_lgl map2_dbl pluck pmap pmap_chr pmap_dbl pwalk keep
...
run_app <- function(
  ...
  # Configurar opciones de formato numérico para evitar conflictos con big.mark y decimal.mark
  # Esto asegura que el separador decimal sea ',' y el de miles sea '.'
  # options(OutDec = ",")
  # options(big.mark = ".", decimal.mark = ",") # Explicitly set for prettyNum
